function [FA,WS]=wavetrans2(signal,type,no,level)
%##########################################################################
% Calculates the 1-D forward transform coefficients and forward transform
% matrix.
%
% Input parameters: 
...
% WS        wavelet transform of signal, row vector.
%
